...
class Library : public MinecraftBuilding {
public:
	Library(gps::Shader& myShader, const float myCornerX, const float myCornerZ);
private:
...
private:
	...
	void addBalconyPillors(const float* xCoord, const float& y, const float* zCoord);
};